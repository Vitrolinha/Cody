...
module.exports = class Decode extends command {
    ...
    async run ({message, usuario}, t) {
        ...
        let codes = usuario.economy.get('lastDecode') === '0000000000000' ? usuario.economy.get('decoders') * 1000 : (parseInt((Date.now() - usuario.economy.get('lastDecode'))/1800000) * (usuario.economy.get('decoders') * 1000))
