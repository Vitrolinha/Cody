const { Client, Collection } = require('discord.js') // testes
    ...
    async newDocDB (doc) {
        if(doc.type === 1) {
            ...
            let usuario = new this.database.Users({
                ...
                vip: { on: false, time: '0000000000000', votePoints: 0, warned: true, warns: false, verify: { day: 0, given: false, dbl: 0, bpd: 0, mbl: false } }
            })
            usuario.save()
        } else if(doc.type === 2) {
